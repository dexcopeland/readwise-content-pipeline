...
<!-- e.g., "prefers 'people' over 'stakeholders'", "uses technical terms without over-explaining" -->

## Structural Preferences
<!-- e.g., "likes to open with a question", "prefers short paragraphs", "uses bullet lists sparingly" -->

## Topics & Expertise
<!-- e.g., "deep knowledge in distributed systems", "writes about leadership and engineering culture" -->
